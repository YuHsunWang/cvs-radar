...
def load_sample() -> list[Post]:
    ...
    return [
        ...
        Post(
            ...
            source="PTT",
            board="CVS",
            title="[商品] 7-11 新品牛肉捲餅",
            brand="7-11",
            product_name="新品牛肉捲餅",
            price="55",
            author="newbie99",
            author_score=95,
            review_text="超好吃推薦大家試試！",
            posted_at=datetime(2026, 6, 10, 14, 0, 0),
            comments=[
                Comment("推", "acc001", "真的好吃", datetime(2026, 6, 10, 14, 5)),
                Comment("噓", "ptt_old", "葉", datetime(2026, 6, 10, 14, 6)),
                Comment("噓", "critic1", "業配吧", datetime(2026, 6, 10, 14, 7)),
                Comment("→", "passerby", "業", datetime(2026, 6, 10, 14, 8)),
                Comment("噓", "ptt_vet", "滿滿的葉味", datetime(2026, 6, 10, 14, 9)),
                Comment("推", "acc002", "還可以啦", datetime(2026, 6, 10, 14, 10)),
            ],
        ),
    ]
