...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "CRAWL": {
        ...
        "cache_path": "data/raw/crawl_seen.json",
    },
    "SENTIMENT": {
        "backend": "lexicon",
    ...
    "PRODUCT_CATEGORIES": {
        ...
        "飲料": [
            "拿鐵", "咖啡", "奶茶", "紅茶", "綠茶", "烏龍", "茶園",
            "豆漿", "牛奶", "鮮奶", "果汁", "汽水", "可樂", "啤酒",
            "思樂冰", "可可", "美式", "卡布", "氣泡",
            "檸檬水", "鳳梨茶", "蜜茶", "冬瓜茶", "梅子", "多多",
            "貝納頌", "光泉", "林鳳營", "瑞穗", "御茶園",
            "茶裏王", "原萃", "麥茶", "果昔", "冰茶",
            "水果茶", "芭樂", "檸檬綠", "鮮橙", "葡萄水",
            "十六茶", "濃湯", "龜記", "微醉",
...
def _confidence_bands_as_tuples(value: list[list[Any]] | list[tuple[Any, ...]]) -> list[tuple[Any, ...]]:
    return [tuple(band) for band in value]


_CONFIG = _load_config()

BRANDS: dict[str, list[str]] = _CONFIG["BRANDS"]
CRAWL = _CONFIG["CRAWL"]
SENTIMENT = _CONFIG["SENTIMENT"]
SCORING = _CONFIG["SCORING"]
PRODUCT_NORMALIZATION = _CONFIG["PRODUCT_NORMALIZATION"]
PRODUCT_ALIASES: dict[str, dict[str, str]] = _CONFIG["PRODUCT_ALIASES"]
BRAND_COMPARISON = _CONFIG["BRAND_COMPARISON"]
SUSPICION = _CONFIG["SUSPICION"]
SHILL_DETECTION = _CONFIG["SHILL_DETECTION"]
CONSENSUS = _CONFIG["CONSENSUS"]
CONFIDENCE_BANDS = _confidence_bands_as_tuples(_CONFIG["CONFIDENCE_BANDS"])
PRODUCT_CATEGORIES: dict[str, list[str]] = _CONFIG["PRODUCT_CATEGORIES"]
